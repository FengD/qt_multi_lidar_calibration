...
# Generated by qmake (2.01a) (Qt 4.8.7) on: ?? 3? 5 16:11:55 2019
# Project:  test.pro
# Template: app
...
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lboost_system -lboost_filesystem -lboost_thread -lpcl_visualization -lpcl_common -lpcl_io -lpcl_kdtree -lpcl_search -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
